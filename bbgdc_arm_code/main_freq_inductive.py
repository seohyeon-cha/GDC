...
from utils import load_data, accuracy_mrun_np, accuracy, normalize_torch, accuracy_np
...
def train_pipeline():
    ...
    for epoch in range(nepochs):
        # t = time.time()
        optimizer.zero_grad()
        output, nll_loss = model(x=x_train
                                , labels=y_train
                                , adj=adj_train
                                , nz_idx=nz_idx_train
                                , obs_idx=idx_train
        ...
        #     acc_test_tr = accuracy(outstmp, y_test)
